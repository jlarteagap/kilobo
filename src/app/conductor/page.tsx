      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">Conductor</h1>
              <p className="text-[11px] text-neutral-500 font-medium">Registro de turnos y optimización</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <Link href="/conductor/settings">
              <Button variant="ghost" size="icon" className="size-9 rounded-lg text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300">
        ...
        {!showForm && !editingShift && (
          <button
            ...
            className="w-full rounded-2xl border-2 border-dashed border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/20 hover:border-emerald-400 dark:hover:border-emerald-700 hover:bg-emerald-50/30 dark:hover:bg-emerald-950/10 transition-all duration-200 p-6 group"
          >
            <div className="flex items-center justify-center gap-3">
              <div className="size-10 rounded-xl bg-emerald-500 flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 group-hover:scale-105 transition-transform">
                <Plus className="size-5" />
              </div>
              <div className="text-left">
                <p className="text-sm font-bold text-neutral-900 dark:text-neutral-100">Registrar turno</p>
                <p className="text-[11px] text-neutral-500">Fecha, horas, km e ingresos — al final del día</p>
              </div>
            </div>
          </button>
        )}
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <div className="size-6 rounded-md bg-neutral-100 dark:bg-neutral-900 flex items-center justify-center text-neutral-500">
              <CarTaxiFront className="size-3" />
            </div>
            <h2 className="text-sm font-semibold text-neutral-700 dark:text-neutral-300">Turnos Registrados</h2>
          </div>
