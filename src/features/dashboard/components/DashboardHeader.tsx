...
function StatItem({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <p className="text-[11px] font-bold text-[#837A75] uppercase tracking-[0.14em]">{label}</p>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-xs font-semibold text-[#837A75] uppercase tracking-[0.14em] capitalize">
          {currentMonthLabel}
        </p>
      </div>

      <div className="bg-white border border-[#E5DED2] card-organic p-6"
        style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}
      >
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 divide-x-0 divide-y lg:divide-y-0 lg:divide-x divide-[#E5DED2]">
        ...
        {currencyBreakdown && currencyBreakdown.length > 0 && (
          <div className="mt-5 pt-5 border-t border-[#E5DED2]">
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
              {currencyBreakdown.map((c) => (
                <div key={c.currency} className="flex items-center gap-2">
                  <span className="text-[10px] font-bold text-[#837A75] uppercase tracking-[0.14em]">
                    {c.currency}
                  </span>
            ...
            {totalInvestedFormatted && (
              <div className="flex items-center gap-2 mt-2">
                <span className="text-[10px] font-bold text-[#5F7D42] uppercase tracking-[0.14em]">
                  Invertido
                </span>
